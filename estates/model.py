...
def resolve_bank_recipe(raw):
    ...
    if r["profile"] != "regional-bank":
        raise DesignError("Supported profiles are 'regional-bank', 'enterprise-data-center', 'school-district', 'hospital-clinics', 'provider-backbone', 'retail-chain', 'university-campus', 'msp', 'manufacturing' and 'utility'. Add a reviewed profile for a new industry.")
...
class World:
    def __init__(self, recipe, previous=None):
        ...
        self.site_prefixlen = {"regional-bank": 20, "enterprise-data-center": 16, "school-district": 16,
                              ...
                              "msp": 16, "manufacturing": 16,
                              "utility": 16}[self.recipe["profile"]]
