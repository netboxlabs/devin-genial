...
PROFILES = {"regional-bank", "enterprise-data-center", "school-district", "hospital-clinics",
            "provider-backbone", "retail-chain"}
...
def _healthy(plan):
    ...
    _require(plan["recipe"].get("profile") in PROFILES, "baseline needs a supported bank, enterprise DC, school, hospital, provider or retail profile")
