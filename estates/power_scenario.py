...
PROFILES = {"regional-bank", "enterprise-data-center", "school-district", "hospital-clinics",
            "provider-backbone", "retail-chain", "university-campus", "msp"}
...
def _healthy(plan):
    ...
    _require(plan["recipe"].get("profile") in PROFILES, "baseline needs a supported bank, enterprise DC, school, hospital, provider, retail, university or MSP profile")
