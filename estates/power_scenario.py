...
def _healthy(plan, label="Power scenario"):
    ...
    _check(plan["recipe"].get("profile") in PROFILES, "baseline needs a supported bank, enterprise DC, school, hospital, provider, retail, university, MSP, manufacturing or utility profile")
